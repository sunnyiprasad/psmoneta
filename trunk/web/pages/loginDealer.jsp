...
<OBJECT id=ipriv codeBase=/psWeb/iprivcom.cab#version=1,0,0,7 height=0
        standby="ПО 'Тонкий клиент'. Версия II" width=0 classid=clsid:47B955CD-0E70-406B-BC50-13EF2EA20B0A></OBJECT>
...
<FORM onsubmit="return GetResultSign(this);" action="loginDealerSubmit.html" method=post>
<input name="accessLevel" value="dealer" type="hidden" />
<textarea NAME="inputmessage" ROWS="6" COLS="70" WRAP=Physical style="width:500">ПОДТВЕРЖДЕНИЕ ПРАВ ДОСТУПА В СИСТЕМУ ПРИЕМА ПЛАТЕЖЕЙ
ДАТА: 9.03.2008
...
<tr>
    <td bgcolor=#5A96CE align=center colspan="2">
        <table>
            <tr>
                <td bgcolor=#5A96CE align=center><font color=#FFFFFF size=2><b>телефон: (8 800) 100-100-8*, (+7 495)
                    ...
                    <a alt="email" class=cl3 href="mailto:support@cyberplat.com"><img alt="email"
                                                                                      ...
                                                                                      border=0 /></a>
                    <nobr />&nbsp;
                        <a alt="icq" href="http://web.icq.com/whitepages/message_me?uin=394034162&action=message"><img
